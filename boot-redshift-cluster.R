...
# -------------------------------------------------------------
# This script is a quick proof-of-concept to explore
# connecting to AWS Redshift, identifying a cluster
# snapshot, restoring that cluster, then shutting it down 
# again. This is a first step in a package which could help 
...
closeAllConnections()
message("Cluster boot time: ",round(end_time-start_time,2)," mins")
